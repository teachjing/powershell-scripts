...
function O365-checkcredentials() {
    ...
    if ($o365session) {
        ...
        $Session = New-PSSession -name 'ExchangeOnline' -ConfigurationName Microsoft.Exchange -ConnectionUri https://outlook.office365.com/powershell-liveid/ -Credential $UserCredentials -Authentication Basic -AllowRedirection
